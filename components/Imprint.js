export default function Imprint() {
  return (
    <>
      <div
        className='container flex flex-col justify-center p-2 mx-auto mt-6 md:p-8 bg-slate-100'
        id='imprint'
      >
        <div className=''>
          <h1 className='project_title'>Imprint</h1>
          <br />
          <br />
          Georgos Gakis
          <br />
          ...
          <br />
          <br />
          <p className='py-10 project_title'>Privacy Policy</p>
          <p>
            I am very delighted that you have shown interest in my web site.
            Data protection is of a particularly high priority for me. The use
            of the Internet pages of the www.georgos-gakis.com site is possible
            without any indication of personal data; however, if a data subject
            wants to use special enterprise services via my website, processing
          ...
          <p>
            ...
            applicable to me. By means of this data protection declaration, our
          ...
          <p>
            As the controller, the www.georgos-gakis.com has implemented
          ...
          <p className='imprint_headers'>1. Definitions</p>
          <p>
            The data protection declaration of the www.georgos-gakis.com is
          ...
          <ul>
            <li>
              <p className='imprint_headers'>a) Personal data</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>b) Data subject</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>c) Processing</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>d) Restriction of processing</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>e) Profiling</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>f) Pseudonymisation</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>h) Processor</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>i) Recipient</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>j) Third party</p>
              <p>
          ...
          <p>
            The Internet pages of the www.georgos-gakis.com use cookies. Cookies
          ...
          <p>
            Through the use of cookies, the www.georgos-gakis.com can provide
          ...
          <p>
            The website of the www.georgos-gakis.com collects a series of
          ...
          <p>
            ...
            www.georgos-gakis.com does not draw any conclusions about the data
            ...
            cyber-attack. Therefore, the www.georgos-gakis.com analyzes
          ...
          <p className='imprint_headers'>6. Newsletter-Tracking</p>
          <p>
            The newsletter of the www.georgos-gakis.com contains so-called
            ...
            embedded tracking pixel, the www.georgos-gakis.com may see if and
          ...
          <p>
            ...
            will be deleted by the controller. The www.georgos-gakis.com
          ...
          <p>
            The website of the www.georgos-gakis.com contains information that
          ...
          <p>
            The www.georgos-gakis.com offers users the possibility to leave
            individual comments on individual blog contributions on a blog,
          ...
          <p>
            The comments made in the blog of the www.georgos-gakis.com may be
            subscribed to by third parties. In particular, there is the
            possibility that a commenter subscribes to the comments following
          ...
          <p className='imprint_headers'>11. Rights of the data subject</p>
          <ul>
            <li>
              <p className='imprint_headers'>a) Right of confirmation</p>
              <p>
            ...
            <li>
              <p className='imprint_headers'>b) Right of access</p>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              <p className='imprint_headers'>c) Right to rectification</p>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              ...
              <p>
                ...
                www.georgos-gakis.com, he or she may, at any time, contact any
                employee of the controller. An employee of www.georgos-gakis.com
              ...
              <p>
                ...
                employees of the www.georgos-gakis.com will arrange the
            ...
            <li>
              ...
              <p>
                ...
                personal data stored by the www.georgos-gakis.com, he or she may
                at any time contact any employee of the controller. The employee
                of the www.georgos-gakis.com will arrange the restriction of the
                processing.
              </p>
            </li>
            <li>
              <p className='imprint_headers'>f) Right to data portability</p>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              <p className='imprint_headers'>g) Right to object</p>
              <p>
                Each data subject shall have the right granted by the European
              ...
              <p>
                The www.georgos-gakis.com shall no longer process the personal
              ...
              <p>
                If the www.georgos-gakis.com processes personal data for direct
                ...
                subject objects to the www.georgos-gakis.com to the processing
                for direct marketing purposes, the www.georgos-gakis.com will no
              ...
              <p>
                ...
                personal data concerning him or her by the www.georgos-gakis.com
              ...
              <p>
                ...
                contact any employee of the www.georgos-gakis.com. In addition,
            ...
            <li>
              ...
              <p>
                ...
                time, contact any employee of the www.georgos-gakis.com.
              </p>
            </li>
            <li>
              <p className='imprint_headers'>
          ...
          <p>
            ...
            corresponding application documents by e-mail or by means of a web
            ...
            Other legitimate interest in this relation is, e.g. a burden of
          ...
          <p>
            ...
            a component. Google+ is a so-called social network. A social network
            is a social meeting place on the Internet, an online community,
            which usually allows users to communicate with each other and
            interact in a virtual space. A social network may serve as a
          ...
          <p>
            ...
            recognizes with each call-up to our website by the data subject and
            for the entire duration of his or her stay on our Internet site,
            which specific sub-pages of our Internet page were visited by the
            data subject. This information is collected through the Google+
            button and Google matches this with the respective Google+ account
          ...
          <p>
            ...
            assigns this information to the personal Google+ user account of the
            data subject and stores the personal data. Google stores the Google+
            1 recommendation of the data subject, making it publicly available
            in accordance with the terms and conditions accepted by the data
            subject in this regard. Subsequently, a Google+ 1 recommendation
            given by the data subject on this website together with other
            personal data, such as the Google+ account name used by the data
            subject and the stored photo, is stored and processed on other
            Google services, such as search-engine results of the Google search
            engine, the Google account of the data subject or in other places,
            e.g. on Internet pages, or in relation to advertisements. Google is
            also able to link the visit to this website with other personal data
            stored on Google. Google further records this personal information
            with the purpose of improving or optimizing the various Google
            services.
          </p>
          <p>
            Through the Google+ button, Google receives information that the
            data subject visited our website, if the data subject at the time of
            the call-up to our website is logged in to Google+. This occurs
          ...
          <p>
            ...
            More references from Google about the Google+ 1 button may be
            obtained under https://developers.google.com/+/web/buttons-policy.
          </p>
          <p className='imprint_headers'>
          ...
          <p>
            ...
            Pinterest Inc. Pinterest is a so-called social network. A social
            network is an Internet social meeting place, an online community
            that allows users to communicate and interact with each other in a
            virtual space. A social network may serve as a platform for the
            exchange of opinions and experiences, or allow the Internet
            community to provide personal or company-related information.
          ...
          <p>
            ...
            component (Pinterest plug-in) was integrated, the Internet browser
            on the information technology system of the data subject
            automatically prompted to download through the respective Pinterest
            component a display of the corresponding Pinterest component.
            Further information on Pinterest is available under
            https://pinterest.com/. During the course of this technical
            procedure, Pinterest gains knowledge of what specific sub-page of
          ...
          <p>
            ...
            component and associated with the respective Pinterest account of
            the data subject. If the data subject clicks on one of the Pinterest
            buttons, integrated on our website, then Pinterest assigns this
            information to the personal Pinterest user account of the data
            subject and stores the personal data.
          </p>
          <p>
            ...
            is not desirable for the data subject, then he or she may prevent
            this by logging off from their Pinterest account before a call-up to
            our website is made.
          </p>
          <p>
          ...
          <p>
            ...
            information technology system of the data subject is automatically
            prompted to download a display of the corresponding XING component
            of XING. Further information about the XING plug-in the may be
            accessed under https://dev.xing.com/plugins. During the course of
            this technical procedure, XING gains knowledge of what specific
            sub-page of our website was visited by the data subject.
          </p>
          <p>
          ...
          <p>
            ...
            occurs regardless of whether the person clicks on the XING component
            or not. If such a transmission of information to XING is not
            desirable for the data subject, then he or she can prevent this by
            logging off from their XING account before a call-up to our website
            is made.
          </p>
          <p>
            ...
            collection, processing and use of personal data by XING. In
          ...
          <p>
            ...
            San Bruno, CA 94066, UNITED STATES. The YouTube, LLC is a subsidiary
            of Google Inc., 1600 Amphitheatre Pkwy, Mountain View, CA
          ...
          <p className='imprint_headers'>23. Legal basis for the processing</p>
          <p>
          ...
          <p className='imprint_headers'>
            26. Provision of personal data as statutory or contractual
          ...
          <p>
            ...
            <a href='https://www.wbs-law.de/'>Media Law Lawyers</a> from
            WBS-LAW.
          </p>
        </div>
      </div>
