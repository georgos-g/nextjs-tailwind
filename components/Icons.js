...
function KitIcon({ size, icon }) {
  return <Icon size={size} icon={icon} tag='i' />;
}

export const MagicMouseIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={44} icon={basic_magic_mouse} />
  </div>
);

export const MailIcon = () => (
  <div style={{ color: 'white' }}>
    <KitIcon size={20} icon={basic_mail} />
  </div>
);

export const ProgrammingIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_pencil_ruler} />
  </div>
);
export const FrameworksIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_cards_diamonds} />
  </div>
);
export const ContentCreationIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_laptop} />
  </div>
);
export const AddressMapIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_map} />
  </div>
);
export const AddressMailIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_paperplane} />
  </div>
);
export const AddressPhoneIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={64} icon={basic_smartphone} />
  </div>
);
export const MoreDetailsIcon = () => (
  <div style={{ color: 'gray' }}>
    <KitIcon size={27} icon={arrows_right} />
  </div>
);
